...
class Serie extends CI_Controller
{
    ...
    public function updatePost()
    {
        ...
        $temporadas_nuevo = isset($_POST['temporadas_nuevo']) && ! empty($_POST['temporadas_nuevo']) ? $_POST['temporadas_nuevo'] : null;
        $capitulos_nuevo = isset($_POST['capitulos_nuevo']) && ! empty($_POST['capitulos_nuevo']) ? $_POST['capitulos_nuevo'] : null;
