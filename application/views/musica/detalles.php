	...
	.comentarios{
		margin-top:3%;
			...
			<div class="fondo">
				...
				<h1 class="titulo"><span><?=$musica->nombre ?></span></h1>
			...
			<br>
				...
				<form action="<?=base_url()?>musica/crearComentario" method="POST">
				...
				<div class="comentarios">
					<?php foreach ($pelicula->ownComentariomusicaList as $comentario): ?>
