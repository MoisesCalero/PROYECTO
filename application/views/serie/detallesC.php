...
<?php endif;?>
	...
	<iframe width="853" height="480" src="https://www.youtube.com/embed?&color=white&listType=search&list=<?=$serie->nombre?> trailer" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	<!-- Dejar un comentario -->
	<div id="comentarios">
	<h3>Comentarios</h3>
	<?php if(isset($_SESSION['id'])):?>
