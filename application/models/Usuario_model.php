...
{
    public function crear($correo, $nombreUsuario, $clave, $nombre, $apellidos, $descripcion, $rol)
    {
        $ok = false;
    ...
    public function update($id, $correo_nuevo, $nombreUsuario_nuevo, $clave_nuevo, $nombre_nuevo, $apellidos_nuevo, $descripcion_nuevo, $rol_nuevo)
    {
        $ok = false;
